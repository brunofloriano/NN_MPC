...
dynamic_function = [dynamic_function 'istatenext(:,agent) = istate(:,agent) + tdelta*[vf*cos( [0 0 1 1]*istate(:,agent) ); vf*sin( [0 0 1 1]*istate(:,agent) ); vf/Length*sin( [0 0 0 1]*istate(:,agent) ); u((agent-1)*m+1:agent*m) ] ;' newline];
...
vdynamic_function = [vdynamic_function 'istatenext(:,agent) = istate(:,agent) + tdelta*[vf*cos( [0 0 1 1]*istate(:,agent) ); vf*sin( [0 0 1 1]*istate(:,agent) ); vf/Length*sin( [0 0 0 1]*istate(:,agent) ); vu((agent-1)*m+1:agent*m) ] ;' newline];
...
dynamic_function0 = 'state0(:,i) = state0(:,i-1) + tdelta*[vf*cos( [0 0 1 1]*state0(:,i-1) ); vf*sin( [0 0 1 1]*state0(:,i-1) ); vf/Length*sin( [0 0 0 1]*state0(:,i-1) ); 0 ] ;';
vdynamic_function0 = 'vstate0(:,vtime) = vstate0(:,vtime-1) + tdelta*[vf*cos( [0 0 1 1]*vstate0(:,vtime-1) ); vf*sin( [0 0 1 1]*vstate0(:,vtime-1) ); vf/Length*sin( [0 0 0 1]*vstate0(:,vtime-1) ); 0 ] ;';
